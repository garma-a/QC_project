  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#faf8f5] via-[#fff8f0] to-[#fef3e2] dark:from-[#121212] dark:via-[#1a1a1a] dark:to-[#1e1e1e] flex items-center justify-center p-4 transition-colors duration-300 myc-pattern relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.03] dark:opacity-[0.08]">
        <div className="absolute top-20 left-20 w-96 h-96 bg-[#b8860b] rounded-full blur-3xl animate-pulse" style={{ animationDuration: '4s' }} />
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-[#003366] rounded-full blur-3xl animate-pulse" style={{ animationDuration: '5s' }} />
