    ...
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
      <div className="w-full max-w-lg bg-white dark:bg-[#1e1e1e] rounded-2xl border-2 border-[#c41e3a]/20 dark:border-[#e84855]/30 p-6 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-gray-700 dark:text-gray-300 mb-2 font-semibold">First Name</label>
            <input
              type="text"
              value={firstName}
          ...
          <div>
            <label className="block text-gray-700 dark:text-gray-300 mb-2 font-semibold">Last Name</label>
            <input
              type="text"
              value={lastName}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-3 mb-1">
                      <div>
                        <h3 className="text-gray-900 dark:text-white font-semibold">{fullName}</h3>
                    ...
                    <div className="space-y-1">
                      ...
                      {technician.sectionName && (
                        <p className="text-gray-600 dark:text-gray-400 text-sm">
                          <span className="font-medium">Section:</span> {technician.sectionName}
                        </p>
                      )}
                      {technician.createdAt && (
                        <p className="text-gray-600 dark:text-gray-400 text-sm">
                          <span className="font-medium">Joined:</span> {new Date(technician.createdAt).toLocaleDateString()}
                        </p>
                      )}
                    </div>
      ...
      <div className="mt-6 bg-gradient-to-br from-[#b8860b]/5 to-[#fef3e2] dark:from-[#ffd700]/10 dark:to-[#2a2a2a] rounded-2xl border-2 border-[#b8860b]/30 dark:border-[#ffd700]/30 p-6 shadow-lg">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-gray-900 dark:text-white font-bold text-lg mb-1">{currentUser?.firstName} {currentUser?.lastName}</h3>
